...
class _$UpdateEventRequest extends UpdateEventRequest {
  ...
  factory _$UpdateEventRequest(
      ...
      (new UpdateEventRequestBuilder()..update(updates)).build();

  _$UpdateEventRequest._({required this.start, this.message}) : super._() {
    BuiltValueNullFieldError.checkNotNull(start, 'UpdateEventRequest', 'start');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('UpdateEventRequest')
          ..add('start', start)
          ..add('message', message))
        .toString();
  }
