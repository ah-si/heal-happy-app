...
class _$DeleteEventRequest extends DeleteEventRequest {
  ...
  factory _$DeleteEventRequest(
      ...
      (new DeleteEventRequestBuilder()..update(updates))._build();

  _$DeleteEventRequest._({required this.message}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        message, r'DeleteEventRequest', 'message');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'DeleteEventRequest')
          ..add('message', message))
        .toString();
  }
}
...
class DeleteEventRequestBuilder
  ...
  @override
  DeleteEventRequest build() => _build();

  _$DeleteEventRequest _build() {
    final _$result = _$v ??
