...
class _$DonationsMonthData extends DonationsMonthData {
  ...
  factory _$DonationsMonthData(
      ...
      (new DonationsMonthDataBuilder()..update(updates)).build();

  _$DonationsMonthData._(
      {required this.total, required this.currency, required this.donations})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(total, 'DonationsMonthData', 'total');
    BuiltValueNullFieldError.checkNotNull(
        currency, 'DonationsMonthData', 'currency');
    BuiltValueNullFieldError.checkNotNull(
        donations, 'DonationsMonthData', 'donations');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('DonationsMonthData')
          ..add('total', total)
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'DonationsMonthData', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
