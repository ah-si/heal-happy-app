...
class _$AskResetPassword extends AskResetPassword {
  ...
  factory _$AskResetPassword(
      ...
      (new AskResetPasswordBuilder()..update(updates)).build();

  _$AskResetPassword._({required this.email}) : super._() {
    BuiltValueNullFieldError.checkNotNull(email, 'AskResetPassword', 'email');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('AskResetPassword')
          ..add('email', email))
        .toString();
  }
}
