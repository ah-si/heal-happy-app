...
class _$PaginatedUsers extends PaginatedUsers {
  ...
  factory _$PaginatedUsers([void Function(PaginatedUsersBuilder)? updates]) =>
      (new PaginatedUsersBuilder()..update(updates)).build();

  _$PaginatedUsers._({required this.totalPages, required this.users})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        totalPages, 'PaginatedUsers', 'totalPages');
    BuiltValueNullFieldError.checkNotNull(users, 'PaginatedUsers', 'users');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('PaginatedUsers')
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'PaginatedUsers', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
