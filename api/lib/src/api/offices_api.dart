...
class OfficesApi {
  ...
  Future<Response<void>> addHealerToRoom({
    ...
    final _path = r'/api/v1/offices/rooms/{id}/healers'.replaceAll('{' r'id' '}', id.toString());
    ...
    try {
      ...
      _bodyData = _serializers.serialize(userEmail, specifiedType: _type);
  ...
  Future<Response<void>> addManager({
    ...
    final _path = r'/api/v1/offices/{id}/managers'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<OfficeRoom>> addRoom({
    ...
    final _path = r'/api/v1/offices/{id}/rooms'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(OfficeRoom);
      _bodyData = _serializers.serialize(officeRoom, specifiedType: _type);
    ...
    OfficeRoom _responseData;

    try {
      const _responseType = FullType(OfficeRoom);
  ...
  Future<Response<OfficeInfo>> createOffice({
    ...
    try {
      const _type = FullType(OfficeInfo);
      _bodyData = _serializers.serialize(officeInfo, specifiedType: _type);
    ...
    OfficeInfo _responseData;

    try {
      const _responseType = FullType(OfficeInfo);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as OfficeInfo;
  ...
  Future<Response<void>> deleteRoom({
    ...
    final _path = r'/api/v1/offices/rooms/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<Office>> getOffice({
    ...
    final _path = r'/api/v1/offices/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    Office _responseData;

    try {
      const _responseType = FullType(Office);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as Office;
  ...
  Future<Response<BuiltList<UserEvent>>> getOfficeEvents({
    ...
    final _path = r'/api/v1/offices/{id}/events'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PaginatedOffices>> getOffices({
    ...
    PaginatedOffices _responseData;

    try {
      const _responseType = FullType(PaginatedOffices);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as PaginatedOffices;
    ...
    return Response<PaginatedOffices>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<void>> removeHealerFromRoom({
    ...
    final _path = r'/api/v1/offices/rooms/{id}/healers/{healerId}'.replaceAll('{' r'id' '}', id.toString()).replaceAll('{' r'healerId' '}', healerId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> removeManager({
    ...
    final _path = r'/api/v1/offices/{id}/managers/{managerId}'.replaceAll('{' r'id' '}', id.toString()).replaceAll('{' r'managerId' '}', managerId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
