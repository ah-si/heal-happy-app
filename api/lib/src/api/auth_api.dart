...
class AuthApi {
  ...
  Future<Response<LoginResponse>> askResetPassword({ 
    ...
    try {
      const _type = FullType(AskResetPassword);
      _bodyData = _serializers.serialize(askResetPassword, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [LoginResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<LoginResponse>> refreshToken({ 
  ...
  Future<Response<void>> resetPassword({ 
    ...
    final _path = r'/api/v1/auth/resetPassword';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
