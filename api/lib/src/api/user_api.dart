...
class UserApi {
  ...
  Future<Response<void>> acceptEvent({
    ...
    final _path = r'/api/v1/users/me/events/{eventId}/accept'.replaceAll('{' r'eventId' '}', eventId.toString());
  ...
  Future<Response<void>> createInviteEvent({
    ...
    final _path = r'/api/v1/healers/{id}/inviteToEvent'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CreateInviteEventRequest);
      _bodyData = createInviteEventRequest == null ? null : _serializers.serialize(createInviteEventRequest, specifiedType: _type);
  ...
  Future<Response<HealerOpening>> createOpening({
    ...
    final _path = r'/api/v1/users/me/openings';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    HealerOpening _responseData;

    try {
      const _responseType = FullType(HealerOpening);
  ...
  Future<Response<HealerOpening>> createUserOpening({
    ...
    final _path = r'/api/v1/users/{userId}/openings'.replaceAll('{' r'userId' '}', userId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> deleteEvent({
    ...
    try {
      const _type = FullType(DeleteEventRequest);
      _bodyData = _serializers.serialize(deleteEventRequest, specifiedType: _type);
  ...
  Future<Response<void>> deleteOpening({
    ...
    final _path = r'/api/v1/users/me/openings/{openingId}'.replaceAll('{' r'openingId' '}', openingId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<HealerAvailabilities>> getHealerAvailabilities({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'type': encodeQueryParameter(_serializers, type, const FullType(HealerEventType)),
    };
  ...
  Future<Response<BuiltMap<String, String>>> getLocalities({
    ...
    final _path = r'/api/v1/healers/localities';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<HealerOpening>>> getOpenings({
    ...
    BuiltList<HealerOpening> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(HealerOpening)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<BuiltList<HealerOpening>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<PaginatedHealers>> searchHealers({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (localization != null) r'localization': encodeQueryParameter(_serializers, localization, const FullType(String)),
      r'type': encodeQueryParameter(_serializers, type, const FullType(HealerEventType)),
  ...
  Future<Response<UserEvent>> updateEvent({
    ...
    try {
      const _type = FullType(UpdateEventRequest);
      _bodyData = updateEventRequest == null ? null : _serializers.serialize(updateEventRequest, specifiedType: _type);
    ...
    UserEvent _responseData;

    try {
      const _responseType = FullType(UserEvent);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as UserEvent;
