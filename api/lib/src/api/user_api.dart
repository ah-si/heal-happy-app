...
class UserApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<Healer>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Healer>>> searchHealers({ 
    required String job,
    ...
    BuiltList<Healer> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(Healer)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BuiltList<Healer>;
    ...
    return Response<BuiltList<Healer>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
