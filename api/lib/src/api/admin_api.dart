...
class AdminApi {
  ...
  Future<Response<User>> blockUser({
    required String id,
    required BlockRequest blockRequest,
    ...
    final _path = r'/api/v1/admin/users/{id}/block'.replaceAll('{' r'id' '}', id.toString());
    ...
    try {
      const _type = FullType(BlockRequest);
      _bodyData = _serializers.serialize(blockRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [DonationsData] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<DonationsData>> getDonations({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/admin/donations';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    DonationsData _responseData;

    try {
      const _responseType = FullType(DonationsData);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as DonationsData;
  ...
  Future<Response<PaginatedEvents>> searchEvents({
    ...
    final _path = r'/api/v1/admin/events';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _responseType = FullType(PaginatedEvents);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as PaginatedEvents;
  ...
  Future<Response<User>> verifyUser({
    required String id,
    required VerifyRequest verifyRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(VerifyRequest);
      _bodyData = _serializers.serialize(verifyRequest, specifiedType: _type);
